...
<div class="mx-auto max-w-6xl px-5 pt-36 pb-16 md:pt-44">
    ...
    <div class="mt-12 grid gap-5 md:grid-cols-2">
        ...
        <div class="rounded-shell border border-espresso/10 bg-near-black p-6 text-warm-cream md:p-8">
            ...
            <p class="mt-3 text-sm leading-relaxed text-warm-cream/75">Ruang hangat dengan material kayu, kulit, dan aksen brass. Foto interior final menyusul. Datang, duduk, dan tahu apa yang terjadi berikutnya.</p>
        </div>
    </div>
